  ...
  return (
    <div className="h-screen">
      <div className="absolute top-8 left-8 flex items-center justify-center">
        <Modal>
          <ModalTrigger className="harry-text-vsmall border border-yellow-300 flex justify-center group/modal-btn">
      ...
      <div className="flex flex-col items-center px-20 py-12">
        <header className="flex flex-col items-center">
          <h1 className="text-4xl font-bold text-white mt-28 harry-text" style={{fontSize: "15rem"}}>
            <TextAnimation text="Gallery" />
          </h1>
            <div className="text-white text-center harry-text-small mt-4 mb-4">
