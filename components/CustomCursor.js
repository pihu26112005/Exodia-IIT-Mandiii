...
const CustomCursor = () => {
  ...
  return (
    <>
      ...
      <div
        ref={cursorRef}
        className="fixed w-10 h-10 bg-[url('/icons/custom/wandd.svg')] bg-contain bg-no-repeat pointer-events-none transform -translate-x-1/2 -translate-y-1/2 z-[100]"
      ></div>

      {/* Light effect */}
      <div
        ref={lightRef}
        className="fixed w-3 h-0 pointer-events-none rounded-full bg-white z-[99] 
