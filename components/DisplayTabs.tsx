  ...
  const tabs = [
    {
      ...
      value: "By Bus",
      content: (
        <div className="space-y-6 text-left w-full overflow-hidden relative md:h-[23rem] h-[60rem] top-10 rounded-2xl md:p-10 font-bold text-white bg-black">
            <motion.div
            ...
            >
              <div className="relative before:content-[''] before:absolute before:left-[-20px] before:top-2 before:w-4 before:h-4 before:bg-yellow-400 before:rounded-full animate-pulse">
    ...
    },
    {
      ...
      value: "By Cabs",
      content: (
        <div className="space-y-6 text-left w-full overflow-hidden md:h-[23rem] h-[60rem] relative top-10 rounded-2xl md:p-10 font-bold text-white bg-black">
            <motion.div
              initial={{ x: -100, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
              viewport={{ once: true }}
