    ...
    <>
      <div>
        <div
          ...
          className={cn(
            "rounded-3xl border-2 border-yellow-300 relative bg-gray-100 dark:bg-neutral-900 overflow-hidden h-60 md:h-80 w-72 transition-all duration-300 ease-out",
