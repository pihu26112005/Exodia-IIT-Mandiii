...
export const HoverEffect = ({
  ...
  return (
    <div
      className={cn(
        "max-w-full py-10 flex flex-wrap justify-center gap-4 mt-5 mb-10",
        className
      )}
    >
      {items.map((item, idx) => (
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-zinc-100 harry-text text-[3rem] font-bold tracking-wide mt-4", className)}>
      {children}
    </h4>
  );
};
